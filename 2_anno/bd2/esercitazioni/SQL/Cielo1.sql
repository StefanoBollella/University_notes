...
-- 10. Quali sono i possibili piani di volo con 
-- esattamente un cambio (utilizzando solo
-- voli della stessa compagnia) da un qualunque
-- aeroporto della città di ‘Roma’ ad un
...
--9. Quali sono i voli che partono da un qualunque 
--aeroporto della città di ‘Roma’ e atterrano ad un
--qualunque aeroporto della città di ‘New York’? 
--Restituire: codice del volo, nome della compagnia,
...
--che hanno voli diretti dalla città di ‘Roma’ alla
--città di ‘New York’?
...
--6. Quali sono le compagnie che hanno voli 
--che partono dall’aeroporto ‘FCO’ e atterrano
-- all’aeroporto ‘JFK’?
...
-- che partono dall’aeroporto con
-- codice ‘CIA’?
